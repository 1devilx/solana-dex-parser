...
describe('Parser', () => {
    ...
    describe('RaydiumLaunchpad', () => {
        it('create', async () => {
            ...
            const create = events[0].data;
            const buy = events[1].data;
            ...
            expect(create.curveParam.data.totalBaseSell.toString()).toEqual("793100000000000");
            ...
            expect(buy.tradeDirection).toEqual(types_1.TradeDirection.Buy);
            expect(buy.poolStatus).toEqual(types_1.PoolStatus.Fund);
        });
        ...
        it('buy_exact_in', async () => {
            ...
            expect(data.tradeDirection).toEqual(types_1.TradeDirection.Buy);
            expect(data.poolStatus).toEqual(types_1.PoolStatus.Fund);
        });
        it('sell_exact_in', async () => {
            ...
            expect(data.tradeDirection).toEqual(types_1.TradeDirection.Sell);
            expect(data.poolStatus).toEqual(types_1.PoolStatus.Fund);
        });
    });
});
